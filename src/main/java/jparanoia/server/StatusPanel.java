...
public class StatusPanel extends javax.swing.JPanel {
    ...
    ImageIcon notConnectedIcon = new ImageIcon( lookup().lookupClass()
            .getClassLoader()
            .getResource( "graphics/notConnectedIcon.jpg" ) );
    ImageIcon connectedIcon = new ImageIcon( lookup().lookupClass()
            .getClassLoader()
            .getResource( "graphics/connectedIcon.jpg" ) );
    ImageIcon mutedIcon = new ImageIcon( lookup().lookupClass()
            .getClassLoader()
            .getResource( "graphics/mutedIcon.jpg" ) );
    ImageIcon frozenIcon = new ImageIcon( lookup().lookupClass()
            .getClassLoader()
            .getResource( "graphics/frozenIcon.jpg" ) );
    ImageIcon combatIcon = new ImageIcon( lookup().lookupClass()
            .getClassLoader()
            .getResource( "graphics/combatIcon.jpg" ) );
    ImageIcon nullMessageIcon = new ImageIcon( lookup().lookupClass()
            .getClassLoader()
            .getResource( "graphics/nullMessageIcon.jpg" ) );
    ImageIcon newMessageIcon = new ImageIcon( lookup().lookupClass()
            .getClassLoader()
            .getResource( "graphics/newMessageIcon.jpg" ) );
    boolean freshTimer;
