...
/*    */     try
/*    */     {
/* 31 */       this.logFile = new File(this.logName);
/* 32 */       this.out = new PrintWriter(new FileWriter(this.logFile), true);
/*    */ 
/*    */     }
/*    */     catch (IOException localIOException)
/*    */     {
/* 37 */       localIOException.printStackTrace();
/* 38 */       JPServer.logBroken = true;
/* 39 */       JPServer.errorMessage("Error creating log file", "JParanoia could not create the log file.\nThis can be caused by deleting or renaming the \"logs\" directory.\nCheck the console for details.");
/*    */     }
/*    */   }
/*    */   
/*    */ 
...
/*    */   {
/* 48 */     this.out.println(paramString);
/*    */   }
/*    */   
/*    */ 
/*    */ 
