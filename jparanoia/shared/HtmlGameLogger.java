...
/*    */   {
/* 13 */     this.logName = ("logs/uv_" + dateFormat.format(new Date()) + ".html");
/* 14 */     createLogFile();
/*    */     
...
/*    */   {
/* 29 */     logEntry(".player0 { color: #" + HexConverter.hexValue(paramArrayOfServerPlayer[0].getChatColor()) + "; font-weight: bold }");
/*    */     
/* 31 */     for (int i = 1; i < paramArrayOfServerPlayer.length; i++)
/*    */     {
/* 33 */       logEntry(".player" + i + " { color: #" + HexConverter.hexValue(paramArrayOfServerPlayer[i].getChatColor()) + " }");
/*    */     }
/*    */     
